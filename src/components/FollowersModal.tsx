    ...
    <Transition appear show={open} as={Fragment}>
      ...
      >
        <div className="min-h-screen px-4 text-center">
          ...
          >
            <div className="my-8 inline-block max-h-[450px] min-h-[350px] w-full max-w-sm transform overflow-y-auto rounded-2xl  bg-white p-10 text-left align-middle text-black shadow-xl transition-all scrollbar-thin scrollbar-track-white scrollbar-thumb-gray-300 dark:bg-dark_primary dark:text-white dark:scrollbar-track-dark_primary dark:scrollbar-thumb-dark_secondary md:max-w-md">
