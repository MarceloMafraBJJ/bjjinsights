  ...
  return (
    <Listbox as="div" className="relative flex h-full w-full flex-col gap-4">
      ...
      <div
        ...
        className="flex cursor-pointer items-center rounded-md bg-light_primary p-4 text-left shadow-sm dark:bg-dark_secondary"
      >
      ...
      <Transition
        ...
        leaveTo="opacity-0"
      >
        <div className="w-[280px] rounded-md bg-light_primary py-1 text-base shadow-lg dark:bg-dark_secondary">
      ...
      >
        <div
          ...
          className="w-[280px] rounded-md bg-light_primary py-1 text-base shadow-lg dark:bg-dark_secondary"
        >
          {belts
